...
window.onload = function(){
	...
	// Function that creates text with gradient
	...
	//Text references
	var p1 = createParagraph('Choose your reward');
	var p4 = createParagraph('When you join Sky with');
	var p6 = createParagraph('1 year free unlimited music with Deezer or £100 M&S Voucher');
	var p9 = createParagraph('Limited time offer');
